...
cd "C:\path\to\V15_Cumulative_13_Case_Ablation\F01"
python main.py
```
...
```powershell
conda activate lstm-py312
cd "C:\path\to\V15_Cumulative_13_Case_Ablation"
python main.py
```
...
- three advisor/report figures and one combined PDF in
  `ComparisonFigures/ReportFigures`.

The three report figures are generated automatically after the comparison:

- `01_feature_ablation_design.png`;
- `02_feature_ablation_results.png`;
- `03_feature_ablation_interpretation.png`.
...
This command also regenerates the three report figures from the saved results.
