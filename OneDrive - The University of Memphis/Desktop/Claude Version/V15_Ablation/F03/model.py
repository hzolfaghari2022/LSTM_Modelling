...
This network fixes that in three ways.
  ...
  3. A zero initialised linear bypass connects the last input sample
     ...
     training starts from the grey-box simulation and the network only has
     to learn what that physical model misses.
"""
...
def describe_model(model):
    ...
    lines = [
        ...
        f"  -> plus grey-box physical simulation (added outside the network)",
