...
def generate_architecture_figure(figures_folder):
    ...
    axis.text(0.2195, 0.615, r"$64\times13$", ha="center", fontsize=17, fontweight="bold", color=BLUE_EDGE)
    axis.text(
        0.2195,
        0.485,
    ...
    axis.text(0.2195, 0.325, "Not 13 physical inputs", ha="center", fontsize=9.4, fontweight="bold", color=PURPLE)
