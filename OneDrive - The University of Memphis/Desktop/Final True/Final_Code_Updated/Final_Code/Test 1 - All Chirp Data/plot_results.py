...
shutil.copy2(
    ...
    FIGURES_FOLDER / "02_untouched_final_test_input.png",

    FIGURES_FOLDER / "02_final_test_input_147mA.png",
...
for index, short_name, display_name, unit in OUTPUTS:
    ...
    shutil.copy2(
        ...
        FIGURES_FOLDER / f"05_final_test_{short_name}.png",

        FIGURES_FOLDER / f"04_{short_name}_tracking_full.png",

    )


zoom_start = int(0.80 * len(final_time))
...
for index, short_name, display_name, unit in OUTPUTS:
    ...
    plt.plot(
        ...
        final_time[zoom_start:],

        final_measured[zoom_start:, index],
    ...
    plt.plot(
        ...
        final_prediction[zoom_start:, index],
    ...
    finish_figure(f"05_{short_name}_high_frequency_zoom.png")
...
for index, short_name, display_name, unit in OUTPUTS:
    ...
    shutil.copy2(
        ...
        FIGURES_FOLDER / f"06_final_test_{short_name}_error.png",

        FIGURES_FOLDER / f"06_{short_name}_error_vs_time.png",
...
axis.text(
    ...
    "Untouched pure test 147 mA: complete series excluded from fitting and model selection.\n"
