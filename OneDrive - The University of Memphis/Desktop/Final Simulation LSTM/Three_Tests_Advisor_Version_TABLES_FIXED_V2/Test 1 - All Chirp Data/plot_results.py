...
axis.text(
    ...
    "Internal held-out 127 mA: distributed blocks from the 127 mA chirp that were not used to fit the model.\n"
    "Untouched pure test 147 mA: the complete 147 mA chirp was excluded from training, validation, and model selection.\n"
