...
from config import (
    ...
    DOWNSAMPLE_FACTOR,
    # Pass `FINAL_TEST_SHEET` as the next value required by the surrounding call or collection.
    FINAL_TEST_SHEET,
    # Pass `MIXED_SHEET` as the next value required by the surrounding call or collection.
    MIXED_SHEET,
    ...
    TEST_STRIDE,
    # Pass `TRAIN_ONLY_SHEETS` as the next value required by the surrounding call or collection.
    TRAIN_ONLY_SHEETS,
...
# Find the workbook and clean one COMSOL sheet
