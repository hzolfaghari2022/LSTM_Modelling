"""Run the five-series FARNN Python simulation with ``python main.py``."""
...
# ---------------------------------------------------------------------
# 2. PAPER-ALIGNED MODEL AND TRAINING
# ---------------------------------------------------------------------
...
# Retained from the supplied project.  Outside its expected repository,
# it reports a clear error after the simulation has already completed.
try:
