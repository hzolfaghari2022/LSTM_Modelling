...
# 1. Exact role allocation in sheets 1-4.
...
# 4. Distributed internal test from sheet 4.
...
# 5. Complete untouched sheet-5 tracking.
for index, short_name, display_name, unit in OUTPUTS:
    plt.figure(figsize=(12, 5))
...
# 7. Metrics table for both independent evaluations.
...
# 8. Pure-test accuracy by lower, middle, and higher chirp regions.
region_rows = []
