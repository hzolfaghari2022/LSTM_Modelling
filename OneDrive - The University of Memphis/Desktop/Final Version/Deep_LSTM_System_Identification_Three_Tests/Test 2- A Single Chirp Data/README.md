# Deep LSTM system identification - one selectable chirp time series
...
```powershell
$env:DLSTM_SINGLE_SHEET="DC_Offset_87mA"
python main.py
```
...
The default maximum is 60 epochs with validation-based early stopping. On the
included 127 mA record and seed 123, the saved run restored epoch 38.
