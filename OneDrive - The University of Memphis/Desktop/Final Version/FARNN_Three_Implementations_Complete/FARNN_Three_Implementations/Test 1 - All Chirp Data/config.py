"""Configuration for the five-series FARNN Python simulation.

The Ogunmolu stacked-LSTM structure is retained.  Only the dimensions
needed by this plant are different:

    1 measured input -> 3 features -> 32 -> 64 -> 64 -> 2 outputs
"""
...
#     $env:FARNN_EPOCHS="30"
#     python main.py
EPOCHS = int(os.environ.get("FARNN_EPOCHS", "20"))
